...
def Parts(mymodel, VR, NR, H, LN, RP, thickness):
    ...
    t_ves, t_pad, t_noz = thickness
    RV = VR          # midsurface radius of shell - should be inner radius but then every different thickness would have a different midsurface position
    RN = NR          # midsurface radius of nozzle - should be outer radius but then every different thickness would have a different midsurface position
